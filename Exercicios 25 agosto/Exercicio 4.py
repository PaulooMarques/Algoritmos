...
def exibir_resultado(vendas, resultado):
    ...
    print(f"2. Dia com MAIS vendas: Dia {resultado['dia_max']} ({resultado['vendas_max']} vendas)")
    print(f"   Dia com MENOS vendas: Dia {resultado['dia_min']} ({resultado['vendas_min']} vendas)")
